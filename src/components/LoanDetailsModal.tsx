...
export default function LoanDetailsModal({ loan, onClose, showActions, onAccept, onReject }: LoanDetailsModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="mb-6">
            <span className={`inline-flex px-4 py-2 rounded-full text-sm font-medium ${getStatusColor(loan.status)}`}>
              Status: {loan.status}
            </span>
          </div>
