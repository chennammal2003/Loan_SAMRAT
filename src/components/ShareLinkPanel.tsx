...
import { Link as LinkIcon, Copy, Loader2, RefreshCw, ToggleLeft, ToggleRight } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {showExpiryPicker && (
        <div className="fixed inset-0 z-40">
          ...
          <div className="relative max-w-md mx-auto mt-24 bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 space-y-4">
